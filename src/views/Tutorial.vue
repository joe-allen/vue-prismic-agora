  ...
  <div id="prismic-tutorial">
            ...
            <ul>
              <li>
                <a href="#bootstrap">
                  ...
                  <img src="../assets/img/tutorial/chevron.svg" alt="Chevron down">
                </a>
              </li>
              <li>
                <a href="#custom-type">
    ...
    <section>
      ...
      <p>
        ...
        <a href="https://prismic.io/#create" target="_blank" rel="noopener">create one</a> choosing a repository name and a plan. We’ve got a variety of plans including our favorite: Free!
      </p>
...
&lt;/script&gt;
      ...
      <p>
        ...
        <em>"Custom Types"</em> section (icon on the left navbar) and create a new Repeatable Type, for this tutorial let’s name it "Page", so that its API ID will be set to
        <strong>"page"</strong>.
      </p>
      <p>
        ...
        <em>"JSON editor"</em> (right sidebar) and paste in the following JSON data.
      </p>
      <p>
...
// ...
      ...
      <p>
        ...
        <em>and voilà!</em> You’ve officially created a Vue component that pulls content from Prismic.
      </p>
